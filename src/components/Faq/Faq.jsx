  ...
  return (
    <div className={styles.SectionWrapper}>
      ...
      <div className={styles.RightSection}>
        <h3 className={styles.RightHeading}>Do I need a personal injury report?</h3>
        ...
        <div className={styles.RightHeading}><h3 >How much is my case worth?</h3> <img src={AccordionLogo} alt="" /></div>
        <div className={styles.Hline}></div>
        <div className={styles.RightHeading}><h3>What should I do right after car accidect</h3><img src={AccordionLogo} alt="" /></div>
        <div className={styles.Hline}></div>
        <div className={styles.RightHeading}><h3>How much is my case worth?</h3><img src={AccordionLogo} alt="" /></div>
